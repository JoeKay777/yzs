		...
		<div class="mMain">
			<div class="container">
				<div class="manage clearfix">
					...
					<div class="tool_main">
						<div class="ce_bread">
							您当前的位置： <a href="<%=basePath%>admin/index.action">管理员中心</a> <span>&gt;</span>管理员详情
						</div>
							...
							<table class="table table-c" cellspacing="0" cellpadding="0"
								...
								<tbody>
									...
									<tr>
										...
										<td style="width: 45%;">
										<input name="admin_truename" id="txtTruename" class="control-text w-md" value="${a.admin_truename }" readonly type="text">
										</td>
									</tr>
									<tr>
										<td><span class="must">*</span> 联系电话：</td>
										<td style="width: 45%;">
										<input name="admin_tel" id="txtMobile" class="control-text w-md" value="${a.admin_tel }" readonly type="text">
										</td>
									</tr>
									<tr>
										<td><span class="must">*</span> 邮箱：</td>
										<td style="width: 45%;">
										<input name="admin_mail" id="txtEmail" class="control-text w-md" value="${a.admin_mail }" readonly type="text">
										</td>
									</tr>
									<tr>
										<td><span class="must">*</span> QQ：</td>
										<td style="width: 45%;">
										<input name="admin_qq" id="txtQQ" class="control-text w-md" value="${a.admin_qq }" readonly type="text">
										</td>
									</tr>
								</tbody>
							</table>
