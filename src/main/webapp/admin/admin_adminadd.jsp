...
<body>
		...
		<div class="mMain">
			<div class="container">
				<div class="manage clearfix">
					...
					<div class="tool_main">
						<div class="ce_bread">
							您当前的位置： <a href="<%=basePath%>admin/index.action">管理员中心</a> <span>&gt;</span>添加管理员
						</div>
							...
							<table class="table table-c" cellspacing="0" cellpadding="0"
								...
								<tbody>
									<tr>
										...
										<td style="width: 45%;">
										 <input name="admin_name" id="txtUsername" class="control-text w-md" placeholder="请输入4-15位的字母+数字组合"  type="text">
										</td>
									...
									<tr>
										...
										<td style="width: 45%;">
										 <input name="admin_pass" id="txtPassword" class="control-text w-md" placeholder="请输入6位以上的密码"  value="" type="password">
										</td>
										<td><span class="control-info control-info-red"
									...
									<tr>
										...
										<td><span class="must">*</span> 确认密码：</td>
										<td style="width: 45%;">
										 <input name="txtCheckPassword" id="txtCheckPassword" class="control-text w-md" placeholder="确认密码" value="" type="password">
										</td>
										<td><span class="control-info control-info-red"
											id="tipCheckPassword"></span></td>
									</tr>
									<tr>
										<td><span class="must">*</span> 联系人：</td>
										<td style="width: 45%;">
										<input name="admin_truename" id="txtTruename" class="control-text w-md" value="" type="text">
										</td>
										<td>
									...
									<tr>
										...
										<td style="width: 45%;">
										<input name="admin_tel" id="txtMobile" class="control-text w-md" value="" type="text">
										</td>
										<td>
											<span class="control-info control-info-red"
											id="tipMobile"></span>
									...
									<tr>
										...
										<td style="width: 45%;">
										<input name="admin_mail" id="txtEmail" class="control-text w-md" value="" type="text">
										</td>
										<td>
											<span class="control-info control-info-red"
											id="tipEmail"></span>
									...
									<tr>
										...
										<td style="width: 45%;">
										<input name="admin_qq" id="txtQQ" class="control-text w-md" value="" type="text">
										</td>
										<td>
											<span class="control-info control-info-red"
											id="tipQQ"></span>
	...
	<script type="text/javascript">
	 function check_submit()
		{
		    if (!check_null("txtUsername","tipUsername","请输入用户名",true)) { return false;}
		    var reg = new RegExp('^[a-zA-Z]{1}[a-zA-Z0-9]{3,14}$');
		            if (!reg.test(jQuery("#txtUsername").val())) {
		            	jQuery("#tipUsername").html("请输入4-15位的字母+数字组合");
		                return false;
		            }
		            else
		            {
		            	jQuery("#tipUsername").html("");
		            }
		    if (!check_null("txtPassword","tipPassword","请输入密码",true)) { return false;}
		    if (jQuery.trim(jQuery("#txtPassword").val()).length < 6) {
		 
		    			jQuery("#tipPassword").html("请输入6位以上的密码！");
		                return false;
		            }
		            else
		            {
		            	jQuery("#tipPassword").html("");
		            }
		    
		    if (jQuery("#txtPassword").val() != jQuery("#txtCheckPassword").val()) {

		    	jQuery("#tipCheckPassword").html("确认密码不一致！");
		        return false;
		    }
		    else
		    {
		    	jQuery("#tipCheckPassword").html("");
		    }
		    ...
		    var reg = /^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\d{8}$/;
		        ...
		        jQuery.ajax({
		            type: "POST",//方法类型
		            url: "<%=basePath%>admin/adminAdd.action" ,//url
		            dataType:"text",
