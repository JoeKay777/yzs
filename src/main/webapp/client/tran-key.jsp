			...
			<div class="manage clearfix">
				...
				<script type="text/javascript">
						...
						function search(currPage) {
							...
							var url = "<%=basePath%>money/tranKeys.action?beginDate=" + beginDate+ 
									"&currPage="+currPage+"&endDate="+endDate+"&keywords="+escape(escape(keywords))+"&dabiao="+dabiao+"&pageSize="+pageSize;
							location.href = url;
						}
				</script>
				<div class="tool_main">
					<div class="ce_bread">
						您当前的位置： <a href="<%=basePath%>user/index.action">会员中心</a> <span>&gt;</span> 关键字扣费详情
					</div>
